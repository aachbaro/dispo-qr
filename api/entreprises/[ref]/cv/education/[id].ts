// api/entreprises/[ref]/cv/education/[id].ts
// -------------------------------------------------------------
// Update / Delete d’une formation (owner/admin)
// -------------------------------------------------------------
//
// 📌 Description :
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (req.method === "PUT") {
      ...
      const updates: TablesUpdate<"cv_education"> = {
        title: body.title,
    ...
    console.error("💥 /api/entreprises/[ref]/cv/education/[id]:", err);
